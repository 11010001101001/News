...
**News 2.0** is a full-featured, high-performance iOS news application built with modern SwiftUI, SwiftData, Combine, Metal Shaders, and ActivityKit. Designed with a custom glassmorphism design system, instant runtime multi-language localization, and comprehensive Unit and UI test coverage.
