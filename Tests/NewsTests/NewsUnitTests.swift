...
struct NewsUnitTests {
    ...
    func testMainViewModelLoadNews() async {
        ...
        #expect(networkManager.loadedCategory == DefaultSettings.category)
    }
    ...
    func testNewsCategoryEnum() {
        ...
        #expect(!String(localized: Strings.categoryTitle).isEmpty)
    }
    ...
    func testAppIconConfigurationEnum() {
        ...
        #expect(!String(localized: Strings.appIconTitle).isEmpty)
    ...
    func testDynamicLocalization() {
        ...
        var settingsLanguageEn = Strings.settingsLanguage
        settingsLanguageEn.locale = Locale(identifier: "en")

        var categoryBusinessEn = Strings.categoryBusiness
        ...
        // 2. Проверяем русский
        var settingsLanguageRu = Strings.settingsLanguage
        settingsLanguageRu.locale = Locale(identifier: "ru")

        var categoryBusinessRu = Strings.categoryBusiness
        ...
        var settingsLanguageId = Strings.settingsLanguage
        settingsLanguageId.locale = Locale(identifier: "id")

        var categoryBusinessId = Strings.categoryBusiness
    ...
    func testSettingsManager() {
        let settingsManager = MockSettingsManager()
        #expect(settingsManager.category == DefaultSettings.category)
        #expect(settingsManager.language == DefaultSettings.language)
